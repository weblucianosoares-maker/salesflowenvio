              ...
              <tbody className="divide-y divide-white/5">
                {leads.map((lead) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <div>
                        <p className="text-sm flex items-center gap-2 font-medium text-white">
                          <Building2 size={14} className="text-primary" />
                          {lead.sector || getMarketFromCNAE(lead.cnae)}
                        </p>
                        <p className="text-[10px] text-zinc-500 mt-1 flex items-center gap-2">
                          <span className="text-zinc-600 font-mono">{lead.cnae || '---'}</span>
                          <span>•</span>
                          <span>{lead.company_size || 'Porte N/A'}</span>
                        </p>
                      </div>
                    </td>
                    <td className="px-6 py-5">
